 ...
 ******************************************************************************/
fsp_vectors_t *fsp_vectors;

/*******************************************************************************
 * Array to keep track of per-cpu Secure Payload state
 ******************************************************************************/
fsp_context_t fspd_sp_context[FSPD_CORE_COUNT];
...
/*******************************************************************************
 * This function is the handler registered for S-EL1 interrupts by the FSPD. It
 * validates the interrupt and upon success arranges entry into the FSP at
 ...
 * FSPD. It validates the interrupt and upon success arranges entry into the
 ...
 * context has already been created by fspd_setup() which can be directly used.
