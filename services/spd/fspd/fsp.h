...
/*
 * This is a copy from bl32/fsp/include/fsp.h. We just keep a copy because (i) we'll
 * have a separate repo for FSP at a later point, and (ii) we don't intend to change
 * fsp.h at all. But for some reason if we update fsp.h, we need to update in both
 * places.
 */ 
