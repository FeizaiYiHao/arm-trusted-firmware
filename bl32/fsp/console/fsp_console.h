...
// */
//int fsp_console_register(console_t *console);
...
//console_t *fsp_console_unregister(console_t *console);
///* Returns 1 if this console is already registered, 0 if not */
//int fsp_console_is_registered(console_t *console);
///*
