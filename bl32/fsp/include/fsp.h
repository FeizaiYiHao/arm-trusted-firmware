...
/*
 * There is a copy of this file in services/spd/fspd. We keep a copy there because (i)
 * we will have a separate repo for FSP at some point, and (ii) we will not change
 * fsp.h at all. But for some reason if we do change fsp.h, we'll need to update in
 * both places.
 */
